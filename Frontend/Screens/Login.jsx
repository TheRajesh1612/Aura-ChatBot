...
const Login = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      const response = await fetch("https://concert-treated-config-ports.trycloudflare.com/api/users/login",
        {
          method: "POST",
          headers: {
            ...
            <KeyboardAvoidingView behavior={Platform.OS === "android" ? "position" : "height"} style={{ flex: 1 }}>
              ...
              <View style={styles.inputContainer}>
                <View style={styles.inputArea}>
                  <TextInput style={styles.input1} placeholder="Email" keyboardType='email-address' onChangeText={(text) => setFormData({ ...formData, email: text })} />
                  {/* <FontAwesomeIcon icon={faBorderStyle} style={{ marginRight: 12, }} /> */}
                  <View style={styles.passwordInput}>
                    <TextInput style={styles.input2} placeholder="Password" secureTextEntry={true} onChangeText={(text) => setFormData({ ...formData, password: text })} />
                ...
                >
                  <LinearGradient colors={["#a965f6ac", "#ab75eae1", "#7d34bdb1", "#5651d7e0"]}
                    ...
                    style={styles.Button}>
                    <Text style={{ color: "white", fontFamily: "sans-serif", fontWeight: "bold", fontSize: 16 }}>Continue</Text>
                  </LinearGradient>
                </TouchableOpacity>
              </View>
